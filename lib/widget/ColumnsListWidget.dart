...
import 'package:study_flutter/tool/CommonUtils.dart';
import 'package:study_flutter/tool/WidgetUtils.dart';
import 'package:study_flutter/ColumnsDetail.dart';

class ColumnsListWidget extends StatefulWidget {
  int id;
  int showType;
  ColumnsListWidget({Key key, @required this.id, this.showType})
      : super(key: key);
  @override
...
class _ColumnsListWidgetState extends State<ColumnsListWidget>
  ...
  Widget build(BuildContext context) {
    return ColumnsContainerWidget(
        context, feedList, _scrollController, showType, widget.id);
  }
}

Widget ColumnsContainerWidget(BuildContext context, List<Feed> feedList,
    ScrollController scrollController, int showType, int id) {
    ...
    child: Column(
      children: <Widget>[
        GestureDetector(
          child: Container(
            height: 50,
            child: ActivityTitleWidget(context, feedList[0].post.column.icon,
...
Widget ColumnstWidget(
    List<Feed> feedList, ScrollController scrollController, int showType) {
  return Flexible(
    ...
    child: Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            child:
                TitleLabel(context, feed.post.title, fontSize: 12, maxLines: 2),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  DescriptionLabel(context,
                      CommonUtils.getNewsTimeStr(feed.post.publishTime * 1000)),
                ],
              ),
