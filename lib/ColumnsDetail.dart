...
import 'package:study_flutter/widget/ColumnsDetailSubWidget.dart';
...
class _ColumnsDetailState extends State<ColumnsDetail> {
  ...
  void getInfoData() async {
    Dio dio = new Dio();
    Response response =
        await dio.get("http://app3.qdaily.com/app3/columns/info/$id.json");
...
Widget ColumnsDetailTile(
    BuildContext context, List<Feed> feedList, MyResponse infoResponse) {
