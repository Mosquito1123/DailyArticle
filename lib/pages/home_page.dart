...
import 'package:study_flutter/news.dart';
                        ...
                        return new DefaultTabController(
                          ...
                          child: new Scaffold(
                            appBar: new AppBar(
                              ...
                              title: new TabBar(
                                ...
                                indicatorSize: TabBarIndicatorSize
                                    .label, //滑动的宽度是根据内容来适应,还是与整块那么大(label表示根据内容来适应)
                                indicatorWeight: 4.0, //滑块高度
                                indicatorColor: Colors.yellow, //滑动颜色
                                indicatorPadding:
                                    EdgeInsets.only(bottom: 1.0), //与底部距离为1
                            ...
                            body: TabBarView(children: [
                              News(
                                  url:
                                      'http://app3.qdaily.com/app3/homes/index_v2/'),
                              News(
                                  url:
                                      'http://app3.qdaily.com/app3/papers/index/')
                            ]),
                          ),
                        );
                      }));
